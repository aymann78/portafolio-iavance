        ...
        <div className="grid gap-3 xl:grid-cols-2">
          {connectorLabels.map((connector) => (
            <button
              ...
              className="min-w-0 rounded-md border border-zinc-800/80 bg-zinc-900 shadow-md shadow-black/40 p-4 text-left transition hover:border-cyan-300/20 hover:bg-white/[0.04]"
            >
