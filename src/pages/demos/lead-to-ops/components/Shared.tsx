...
export function DecisionRow({
  ...
  return (
    <div className="flex flex-col gap-1.5 border-b border-zinc-800/80 pb-3 last:border-0 last:pb-0">
...
export function ActivityFeed({ items }: { items: ActivityItem[] }) {
  return (
    <div className="space-y-3">
      {items.map((item) => (
        <div key={item.id} className="rounded-md border border-zinc-800/80 bg-zinc-900 shadow-md shadow-black/40  px-4 py-3">
