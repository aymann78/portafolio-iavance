...
export function DecisionRow({
  ...
  return (
    <div className="flex flex-col gap-1.5 border-b border-zinc-800 pb-3 last:border-0 last:pb-0">
...
export function ActivityFeed({ items }: { items: ActivityItem[] }) {
  return (
    <div className="space-y-3">
      {items.map((item) => (
        <div key={item.id} className="rounded-md border border-zinc-800 bg-zinc-950  px-4 py-3">
